  ...
  if (!project) {
    return (
      <div className={styles.loading}>
        ...
        <button onClick={() => router.push('/')} className={styles.navButton}>Back to Home</button>
      </div>
    );
  }
    ...
    <div className={styles.page}>
      ...
      <div className={styles.hero}>
        <div className={styles.heroContent}>
          <img src={project.logo || '/default-logo.png'} alt={project.name} className={styles.heroLogo} />
          <div className={styles.heroInfo}>
            <h1 className={styles.heroTitle}>{project.name}</h1>
            <div className={styles.heroMeta}>
              <span className={styles.heroSymbol}>${project.symbol}</span>
              {project.launchpad && <span className={styles.heroLaunchpad}>{project.launchpad}</span>}
            </div>
            <div className={styles.heroSocials}>
              {project.socials?.website && <a href={project.socials.website} target="_blank" rel="noopener noreferrer" className={styles.socialBtn}>🌐</a>}
              {project.socials?.twitter && <a href={project.socials.twitter} target="_blank" rel="noopener noreferrer" className={styles.socialBtn}>𝕏</a>}
              {project.socials?.telegram && <a href={project.socials.telegram} target="_blank" rel="noopener noreferrer" className={styles.socialBtn}>✈️</a>}
              {project.socials?.github && <a href={project.socials.github} target="_blank" rel="noopener noreferrer" className={styles.socialBtn}>💻</a>}
            </div>
          </div>
        </div>
      </div>
          ...
          <div className={styles.card}>
            ...
            <div className={styles.infoGrid}>
              ...
              <div className={styles.infoRow}>
                ...
                <span className={styles.valueAddress}>{project.contract_info?.contract_address || 'N/A'}</span>
              </div>
            </div>
          </div>
          ...
          <div className={styles.card}>
            ...
            <div className={styles.analysisGrid}>
              <div className={styles.analysisRow}>
                ...
                <span className={styles.value}>{project.decimals}</span>
              </div>
              <div className={styles.analysisRow}>
                <span className={styles.label}>Token Total Supply</span>
                <span className={styles.value}>{project.supply}</span>
              </div>
              <div className={styles.analysisRow}>
              ...
              <div className={styles.analysisRow}>
                ...
                <span className={styles.value}>{project.contract_info?.contract_compiler || 'N/A'}</span>
              </div>
              <div className={styles.analysisRow}>
                <span className={styles.label}>Sol License</span>
                <span className={styles.value}>{project.contract_info?.contract_license || 'N/A'}</span>
              </div>
              <div className={styles.analysisRow}>
                <span className={styles.label}>Contract Name</span>
                <span className={styles.value}>{project.contract_info?.contract_name || 'N/A'}</span>
              </div>
              <div className={styles.analysisRow}>
          ...
          <div className={styles.card}>
            ...
            <div className={styles.addressGrid}>
              <div className={styles.addressRow}>
                ...
                <span className={styles.valueAddress}>{project.contract_info?.contract_owner || 'N/A'}</span>
              </div>
              <div className={styles.addressRow}>
                <span className={styles.label}>Deployer Address</span>
                <span className={styles.valueAddress}>{project.contract_info?.contract_deployer || 'N/A'}</span>
              </div>
            </div>
          </div>
        ...
        <div className={styles.rightColumn}>
          ...
          <div className={styles.card}>
            ...
            <div className={styles.confidenceStars}>
              {renderStars(project.audit_confidence || 'Medium')}
            </div>
